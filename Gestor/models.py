...
class Cargo(ModeloBase):
    ...
    imgref = models.ImageField('Imagen de Referencia', upload_to='empresa/cargo', null=True, blank=True)
...
class Empleado(ModeloBase):
    ...
    nac = models.CharField('Nacionalidad', max_length=1, choices=lista_Nacionalidad, null=False, default='v')

    cedula = models.CharField('Cedula', max_length=10, null=False, unique=True)
    codpatria = models.CharField('Codigo Patria', max_length=10, null=False, default='0000000000')
    serialpatria = models.CharField('Serial Patria', max_length=10, null=False, default='0000000000')
    ...
    observacion = models.TextField('Observaciones', max_length=255,  null=True, blank=True)
